...
export const metadata: Metadata = {
  ...
  description:
    "Teilen Sie Rechnungen einfach auf Geschäftsperioden auf. Splitten Sie Zahlungen in monatliche, vierteljährliche und jährliche Abschnitte gemäß IFRS 15, HGB und OR.",
  alternates,
  openGraph: {
    title: "BillSplitter – Rechnungen auf Geschäftsjahre aufteilen",
    description:
