    ...
    <div className="container mx-auto py-12">
      ...
      <section className="mb-12">
        ...
        <div className="flex flex-col gap-4">
          <div className="border p-4 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">font-size: 2.25rem (36px), font-weight: 700</p>
          </div>
          <div className="border p-4 rounded-lg">
            <h2 className="text-3xl font-semibold">Heading 2</h2>
            <p className="text-sm text-muted-foreground">font-size: 1.875rem (30px), font-weight: 600</p>
          </div>
          <div className="border p-4 rounded-lg">
            <h3 className="text-2xl font-semibold">Heading 3</h3>
            <p className="text-sm text-muted-foreground">font-size: 1.5rem (24px), font-weight: 600</p>
          </div>
          <div className="border p-4 rounded-lg">
          ...
          <div className="border p-4 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">font-size: 1rem (16px), font-weight: 400</p>
          </div>
          <div className="border p-4 rounded-lg">
            <p className="text-sm">Small Text: The quick brown fox jumps over the lazy dog.</p>
            <p className="text-sm text-muted-foreground">font-size: 0.875rem (14px), font-weight: 400</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="flex flex-wrap gap-4 mb-4">
          ...
          <button className="border border-input bg-background hover:bg-accent hover:text-accent-foreground px-4 py-2 rounded-md">Outline</button>
          <button className="px-4 py-2 rounded-md" disabled>Disabled</button>
        </div>
        
        <div className="flex flex-wrap gap-4">
          <button className="bg-primary text-primary-foreground px-3 py-1.5 text-sm rounded-md">Small</button>
          <button className="bg-primary text-primary-foreground px-4 py-2 rounded-md">Default</button>
          <button className="bg-primary text-primary-foreground px-6 py-3 rounded-md">Large</button>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium mb-1" htmlFor="input">Text Input</label>
            <input 
              type="text" 
              id="input" 
          ...
          <div>
            ...
            <div className="flex items-center">
              <input type="checkbox" id="checkbox" className="rounded border-input mr-2" />
      ...
      <section className="mb-12">
        ...
        <p>Click the theme toggle in the header to switch between light and dark mode.</p>
        <p className="text-sm text-muted-foreground mt-2">
          This will help verify that all theme variables are properly transitioning between modes.
        </p>
      </section>
    </div>
  );
