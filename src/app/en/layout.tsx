...
export const metadata: Metadata = {
  ...
  description:
    "Easily allocate invoices across fiscal periods. Split payments into monthly, quarterly, or yearly segments while maintaining IFRS 15, HGB, and OR compliance.",
  alternates,
  openGraph: {
    title: "BillSplitter – Split Invoices Across Fiscal Years",
    description:
