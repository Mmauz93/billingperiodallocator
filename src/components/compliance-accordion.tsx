...
export function ComplianceAccordion() {
  const answer = (
    <>
      Yes, BillSplitter follows the principles of accrual accounting in accordance with{" "}
      ...
      , and{" "}
      <span className="inline-flex whitespace-nowrap">
        <a href='https://www.fedlex.admin.ch/eli/cc/27/317_321_377/en'
          target='_blank'
          rel='noopener noreferrer' 
          className="text-primary hover:underline"
        >OR</a>
      </span>
      {" "}standards, making it suitable for proper recognition of deferred revenue and prepaid expenses in financial statements.
    </>
  );
