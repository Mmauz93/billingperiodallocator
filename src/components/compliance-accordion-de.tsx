...
export function ComplianceAccordionDE() {
  const answer = (
    <>
      Ja, BillSplitter folgt den Grundsätzen der periodengerechten
      Rechnungslegung gemäss{" "}
      ...
      <span className="inline-flex whitespace-nowrap">
        <a
          href="https://www.fedlex.admin.ch/eli/cc/27/317_321_377/de"
          target="_blank"
          rel="noopener noreferrer"
          className="text-primary hover:underline"
        >
      ...
      Standards, und eignet sich somit für die korrekte Erfassung von passiven
      und aktiven Rechnungsabgrenzungsposten in der Finanzbuchhaltung.
    </>
  );
